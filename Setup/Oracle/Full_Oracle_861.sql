...
CREATE USER RTR_DT8N  PROFILE "DEFAULT" IDENTIFIED BY "reut" DEFAULT TABLESPACE DT_ARCHIVE8N TEMPORARY TABLESPACE TEMP_SPACE8N ACCOUNT UNLOCK;
GRANT "CONNECT" TO RTR_DT8N;
ALTER USER RTR_DT8N DEFAULT ROLE ALL;
ALTER USER RTR_DT8N QUOTA UNLIMITED ON DT_ARCHIVE8N;
ALTER USER RTR_DT8N QUOTA UNLIMITED ON INDEX_SPACE8N;

GRANT CREATE JOB TO RTR_DT8N;

CREATE TABLE RTR_DT8N.CONVERSATIONS (
	TCID CHAR(4) NULL,
...
CREATE INDEX RTR_DT8N.Conversations_CCY1 ON RTR_DT8N.Conversations(CURRENCY1) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_CCY2 ON RTR_DT8N.Conversations(CURRENCY2) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_DType ON RTR_DT8N.Conversations(PUREDEALTYPE, DEALTYPE) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_Logon ON RTR_DT8N.Conversations(LOCALTCID, DEALERID, DEALERNAME) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_Dealer ON RTR_DT8N.Conversations(DEALERID) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_NoDeal ON RTR_DT8N.Conversations(NODEAL) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_SR ON RTR_DT8N.Conversations(SOURCEREFERENCE) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_TCID ON RTR_DT8N.Conversations(BANK1DEALINGCODE) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_TOD ON RTR_DT8N.Conversations(TIMEOFDEAL) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_COVERIDX1 ON RTR_DT8N.Conversations(SOURCEREFERENCE, TCID, TIMEOFDEAL, TICKETSTATUS, NODEAL) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_DTFEID ON RTR_DT8N.Conversations(DTFEID) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_ARCHIVETIME ON RTR_DT8N.Conversations(ARCHIVETIME) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.Conversations_Processed ON RTR_DT8N.Conversations(PROCESSED) TABLESPACE INDEX_SPACE8N;



CREATE TABLE RTR_DT8N.TICKETS(
	DEALID CHAR(15) NULL,
	PROCESSED NUMBER(3) DEFAULT 0,
	PROCESSEDBY VARCHAR2(200) NULL,
	PROCESSEDAT DATE NULL,
...
CREATE INDEX RTR_DT8N.TICKETS_CCY1 ON RTR_DT8N.TICKETS(CURRENCY1) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_CCY2 ON RTR_DT8N.TICKETS(CURRENCY2) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_DEALER ON RTR_DT8N.TICKETS(DEALERID) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_DEALID ON RTR_DT8N.TICKETS(DEALID) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_DTYPE ON RTR_DT8N.TICKETS(PUREDEALTYPE, DEALTYPE) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_LOGON ON RTR_DT8N.TICKETS(LOCALTCID, DEALERID, DEALERNAME) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_PROCESSED ON RTR_DT8N.TICKETS(PROCESSED) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_RRN ON RTR_DT8N.TICKETS(REVIEWREFERENCENUMBER) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_SR ON RTR_DT8N.TICKETS(SOURCEREFERENCE) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_TCID ON RTR_DT8N.TICKETS(BANK1DEALINGCODE) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_TOD ON RTR_DT8N.TICKETS(TIMEOFDEAL) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_DEALERNAME ON RTR_DT8N.TICKETS(DEALERNAME) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_COVERIDX1 ON RTR_DT8N.TICKETS(LOCALTCID, DEALERID, DEALERNAME, SOURCEREFERENCE, TIMEOFDEAL) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_COVERIDX2 ON RTR_DT8N.TICKETS(TIMEOFDEAL, LOCALTCID, SOURCEREFERENCE, PUREDEALTYPE, BANK1DEALINGCODE, CURRENCY1, DEALVOLUMECURRENCY1, BANK1NAME) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_COVERIDX3 ON RTR_DT8N.TICKETS(TIMEOFDEAL, CURRENCY1, LOCALTCID, PUREDEALTYPE, CURRENCY2, DEALVOLUMECURRENCY1) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_COVERIDX4 ON RTR_DT8N.TICKETS(TIMEOFDEAL, LOCALTCID, SOURCEREFERENCE, BANK1DEALINGCODE, BANK1NAME) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.TICKETS_COVERIDX5 ON RTR_DT8N.TICKETS(LOCALTCID, SOURCEREFERENCE, TIMEOFDEAL, DEALID, PROCESSED, PROCESSEDBY, SOURCEOFDATA) TABLESPACE INDEX_SPACE8N;


CREATE TABLE RTR_DT8N.CALLS(
...
CREATE INDEX RTR_DT8N.CIDX_CALLTIME ON RTR_DT8N.CALLS(CALLTIME) TABLESPACE INDEX_SPACE8N;



CREATE TABLE RTR_DT8N.COUNTERPARTIES(
...
CREATE UNIQUE INDEX RTR_DT8N.Counterparties_TCID ON RTR_DT8N.Counterparties(LOCALTCID) TABLESPACE INDEX_SPACE8N;



CREATE TABLE RTR_DT8N.USERS(
...
CREATE UNIQUE INDEX RTR_DT8N.USERS_ID ON RTR_DT8N.USERS(USERID) TABLESPACE INDEX_SPACE8N;
ALTER TABLE RTR_DT8N.USERS ADD CONSTRAINT PK_USERID PRIMARY KEY (USERID);



CREATE TABLE RTR_DT8N.REPORTS(
	DESCRIPTION VARCHAR2(60) NULL,
	REPFILE VARCHAR2(50) NULL,
	CUSTOMREPORTID NUMBER(10,0) NULL,
	CHOSEN NUMBER(1,0) NOT NULL
) TABLESPACE DT_ARCHIVE8N;
CREATE UNIQUE INDEX RTR_DT8N.Reports_Id ON RTR_DT8N.Reports(CUSTOMREPORTID) TABLESPACE INDEX_SPACE8N;



CREATE TABLE RTR_DT8N.VERSION(
...
CREATE TABLE RTR_DT8N.TBUSERAUDIT(
...
CREATE TABLE RTR_DT8N.TBRUNNINGNUMBER(
...
INSERT INTO RTR_DT8N.TBRUNNINGNUMBER(KEYNAME,RUNNINGVALUE,MINVALUE,MAXVALUE) VALUES ('AutoTicketDealID',1,1,999999);
INSERT INTO RTR_DT8N.TBRUNNINGNUMBER(KEYNAME,RUNNINGVALUE,MINVALUE,MAXVALUE) VALUES ('ManualTicketDealID',1,1,999999);



CREATE TABLE RTR_DT8N.TBAUTOTICKETSGENERATIONTCIDS(
    LOCALTCID CHAR(4) NOT NULL
) TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.TBAUTOTICKETSGENERATIONTCIDS ADD CONSTRAINT PK_TBAUTOTICKETSTCIDS PRIMARY KEY (LOCALTCID);



CREATE TABLE RTR_DT8N.TBAUTOCHECKNODEALTCIDS(
    LOCALTCID CHAR(4) NOT NULL
) TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.TBAUTOCHECKNODEALTCIDS ADD CONSTRAINT PK_TBAUTOCHECKNODEALTCIDS PRIMARY KEY (LOCALTCID);



CREATE TABLE RTR_DT8N.TBLOGINLOG(
    USERID VARCHAR2(255) NULL,
	DATETIME DATE DEFAULT SYS_EXTRACT_UTC(SYSTIMESTAMP) NOT NULL,
	STATUS NUMBER(3,0) DEFAULT 0  NOT NULL
) TABLESPACE DT_ARCHIVE8N;
CREATE INDEX RTR_DT8N.TBLOGINLOG_DATETIME ON RTR_DT8N.TBLOGINLOG(DATETIME) TABLESPACE INDEX_SPACE8N;



CREATE TABLE RTR_DT8N.TBTRADELOG(
    USERID VARCHAR2(255) NULL,
    USERNAME VARCHAR2(30) NULL,
...
CREATE INDEX RTR_DT8N.TBTRADELOG_ACCESSDATETIME ON RTR_DT8N.TBTRADELOG(ACCESSDATETIME) TABLESPACE INDEX_SPACE8N;



CREATE TABLE RTR_DT8N.TBADMINLOG(
...
CREATE INDEX RTR_DT8N.TBADMINLOG_DATETIME ON RTR_DT8N.TBADMINLOG(DATETIME) TABLESPACE INDEX_SPACE8N;



--tbSystemConfiguration
CREATE TABLE RTR_DT8N.TBSYSTEMCONFIGURATION(
...
SET DEFINE OFF;
INSERT INTO RTR_DT8N.TBSYSTEMCONFIGURATION (
	AUDITTRAILLOGENABLE
...
--tbSourceOfData
CREATE TABLE RTR_DT8N.tbSourceOfData(
	Code NUMBER(3,0),
	SOURCE VARCHAR2(50),
	APPLYBROKERNAME NUMBER(3) NULL
 )TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.tbSourceOfData ADD CONSTRAINT PK_tbSourceOfData PRIMARY KEY (Code);

INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (1,'Offline');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (2,'Matching');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (3,'Dealing');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (4,'EBS');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (5,'Manual');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (6,'DDN');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (8,'ICAP-E');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (9,'ICAP-V');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (10,'RTF-CME');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (11,'3rd Party');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (12,'RTFX');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (17,'FXMS');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (18,'FXMS Clearing');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (21,'DB AutoBahn');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (30,'RP Martin');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (31,'BGC eSpeed');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (32,'Meitan');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (36,'Tradition');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (38,'Bierbaums');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (39,'DirectFX');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (43,'Tullet Prebon');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (45,'Carl Kliem');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (51,'Citibank');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (61,'Conticap');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (66,'Electronic Trading');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (73,'Electronic Trading');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (77,'Electronic Trading');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (80,'BARX');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (81,'3rd Party');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (82,'ET');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (83,'Refinitiv Dealing Aggregator');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (84,'Adv Dealing');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (90,'FXall POMS');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (91,'FXall Order Book');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (92,'FXall Bankstream');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (93,'FXall Treasury Center');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (98,'MM Callouts');
INSERT INTO RTR_DT8N.tbSourceOfData(Code,Source) VALUES (99,'Auctions');



CREATE TABLE RTR_DT8N.TBPUREDEALTYPE(
	CODE NUMBER(10,0),
	DEALTYPE VARCHAR2(50)
 )TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.TBPUREDEALTYPE ADD CONSTRAINT PK_TBPUREDEALTYPE PRIMARY KEY (CODE);

INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (2,'Spot');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (4,'Outright');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (7,'FXO');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (8,'Swap');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (9,'OIS');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (10,'IRS');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (13,'Repo');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (14,'FI');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (16,'Deposit');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (18,'Netting');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (21,'Banknote');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (32,'FRA');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (64,'Bullion');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (128,'Outright');
INSERT INTO RTR_DT8N.TBPUREDEALTYPE(CODE,DEALTYPE) VALUES (32000,'Other');



CREATE TABLE RTR_DT8N.TBDEALTYPE(
	CODE NUMBER(3,0),
	DIRECTION VARCHAR2(50),
	DIRECTIONLIST VARCHAR2(50)
)TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.TBDEALTYPE ADD CONSTRAINT PK_TBDEALTYPE PRIMARY KEY (CODE);

INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (1,'Buy','Buy');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (2,'Sell','Sell');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (3,'Buy ' || chr(38) || ' Sell','Buy ' || chr(38) || ' Sell');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (4,'Sell ' || chr(38) || ' Buy','Sell ' || chr(38) || ' Buy');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (5,'Lend','Lend (Deposit)');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (6,'Borrow','Borrow (Deposit)');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (7,'Lend','Lend (FRA)');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (8,'Borrow','Borrow (FRA)');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (9,'Receive','Receive');
INSERT INTO RTR_DT8N.TBDEALTYPE(CODE,DIRECTION,DIRECTIONLIST) VALUES (10,'Pay','Pay');



CREATE TABLE RTR_DT8N.VERSIONTHIRDPARTY(
...
CREATE TABLE RTR_DT8N.TBCLEARINGHOUSE(
	CLEARERNUMBER NUMBER(10,0) NOT NULL,
	CLEARERFULLNAME VARCHAR2(50) NOT NULL
 )TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.TBCLEARINGHOUSE ADD CONSTRAINT PK_TBCLEARINGHOUSE PRIMARY KEY (CLEARERNUMBER);



CREATE TABLE RTR_DT8N.TBUSERCUSTOMIZEVIEW(
	USERID VARCHAR2(255) NOT NULL,
...
INSERT INTO RTR_DT8N.TBROLES(ROLE, ROLENAME, PERMISSIONS, HOMEPAGELAYOUT) VALUES (0, 'Administrator', 32734, 511);
INSERT INTO RTR_DT8N.TBROLES(ROLE, ROLENAME) VALUES (1, 'BO Manager');
INSERT INTO RTR_DT8N.TBROLES(ROLE, ROLENAME) VALUES (2, 'eTrader');
INSERT INTO RTR_DT8N.TBROLES(ROLE, ROLENAME) VALUES (3, 'MO Manager');
INSERT INTO RTR_DT8N.TBROLES(ROLE, ROLENAME) VALUES (4, 'Trader');
INSERT INTO RTR_DT8N.TBROLES(ROLE, ROLENAME, PERMISSIONS, HOMEPAGELAYOUT, DEFAULTROLE) VALUES (5, 'User', 80, 387, 1);
INSERT INTO RTR_DT8N.TBROLES(ROLE, ROLENAME) VALUES (255, 'Unknown');



--tbCustomDealingFields
CREATE TABLE RTR_DT8N.TBCUSTOMDEALINGFIELDS (
...
CREATE TABLE RTR_DT8N.TBCHECKTICKETSTCIDS(
    LOCALTCID CHAR(4) NOT NULL
) TABLESPACE DT_ARCHIVE8N;



CREATE TABLE RTR_DT8N.TBUSERTCIDDEALEREXCEPTIONLIST(
    USERID_FK VARCHAR2(255) NOT NULL,
    LOCALTCID CHAR(4) NOT NULL,
    DEALERID VARCHAR2(40) NOT NULL
) TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.TBUSERTCIDDEALEREXCEPTIONLIST ADD CONSTRAINT PK_TBUSRTCIDDEALEREXCEPTION PRIMARY KEY (USERID_FK, LOCALTCID, DEALERID)
USING INDEX TABLESPACE DT_ARCHIVE8N;



CREATE TABLE RTR_DT8N.TBSEARCH(
...
ALTER TABLE RTR_DT8N.TBSEARCH ADD CONSTRAINT PK_TBSEARCH PRIMARY KEY (SEARCHID);



CREATE TABLE RTR_DT8N.TBSEARCHFIELD(
...
ALTER TABLE RTR_DT8N.TBSEARCHFIELD ADD CONSTRAINT PK_TBSEARCHFIELD PRIMARY KEY (ID);



CREATE TABLE RTR_DT8N.TBMYLINKSPERSONALIZATION(
	WEBPARTID Number(3,0) NOT NULL,
	USERID VARCHAR2(255) NOT NULL,
	ZONEID Number(3,0) NOT NULL,
	ZONEINDEX Number(3,0) NOT NULL
) TABLESPACE DT_ARCHIVE8N;
ALTER TABLE RTR_DT8N.TBMYLINKSPERSONALIZATION ADD CONSTRAINT PK_TBMYLINKSPERSONALIZATION PRIMARY KEY (WEBPARTID, USERID);



CREATE TABLE RTR_DT8N.TBUSERDEFINED
(
...
CREATE TABLE RTR_DT8N.ALLOCATIONS(
	DEALID CHAR(15) NULL,
	LOCALTCID CHAR(4) NULL,
	SOURCEREFERENCE CHAR(11) NOT NULL,
	TIMEOFDEAL DATE NOT NULL,
 ...
 CREATE TABLE RTR_DT8N.CONVERSATIONSCENTRIC (
	TCID CHAR(4) NULL,
	SOURCEREFERENCE CHAR(11) NOT NULL,
	LOCALTCID CHAR(4) NULL,
	TIMEOFDEAL DATE NOT NULL,
...
CREATE INDEX RTR_DT8N.CONVCENTRIC_SR ON RTR_DT8N.CONVERSATIONSCENTRIC(SOURCEREFERENCE) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.CONVCENTRIC_COVERIDX1 ON RTR_DT8N.CONVERSATIONSCENTRIC(SOURCEREFERENCE, TCID, TIMEOFDEAL) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.CONVCENTRIC_TOD ON RTR_DT8N.CONVERSATIONSCENTRIC(TIMEOFDEAL) TABLESPACE INDEX_SPACE8N;
CREATE INDEX RTR_DT8N.CONVCENTRIC_LOCALTCID ON RTR_DT8N.CONVERSATIONSCENTRIC(LOCALTCID) TABLESPACE INDEX_SPACE8N;

CREATE TABLE RTR_DT8N.RATESOURCES(
	DEALID CHAR(15) NOT NULL,
	LOCALTCID CHAR(4) NOT NULL,
	SOURCEREFERENCE CHAR(11) NOT NULL,
	TIMEOFDEAL DATE NOT NULL,
...
CREATE TABLE RTR_DT8N.TBTRADEREPORT(
...
ALTER TABLE RTR_DT8N.TBTRADEREPORT ADD CONSTRAINT PK_TBTRADEREPORT PRIMARY KEY (REPORTID);


CREATE GLOBAL TEMPORARY TABLE RTR_DT8N.TEMPORARY_CONV_TEXT(
  CONVERSATIONTEXT  CLOB NULL
) ON COMMIT DELETE ROWS;



CREATE SEQUENCE RTR_DT8N.SEQUENCE_TBSEARCHFIELD_ID
START WITH 1
INCREMENT BY 1
NOCACHE
;
...
CREATE SEQUENCE RTR_DT8N.SEQUENCE_TBSEARCH_SEARCHID
START WITH 1
INCREMENT BY 1
NOCACHE
;
...
CREATE SEQUENCE RTR_DT8N.SEQUENCE_TBTRADEREPORT_REPORTID
START WITH 1
INCREMENT BY 1
NOCACHE
;
...
CREATE OR REPLACE TRIGGER RTR_DT8N.TRG_INCREMENTSEARCHFIELDID
BEFORE INSERT
ON RTR_DT8N.TBSEARCHFIELD
...
CREATE OR REPLACE TRIGGER RTR_DT8N.TRG_INCREMENTSEARCHID
BEFORE INSERT
ON RTR_DT8N.TBSEARCH
REFERENCING NEW AS NEW
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER RTR_DT8N.TRG_INCREMENTREPORTID
BEFORE INSERT
ON RTR_DT8N.TBTRADEREPORT
REFERENCING NEW AS NEW
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER RTR_DT8N.AUTOCHECKTICKETSFORTCIDS
BEFORE INSERT 
ON RTR_DT8N.TICKETS
REFERENCING  NEW AS NEW
FOR EACH ROW 
...
CREATE OR REPLACE TRIGGER RTR_DT8N.CONVINSERTEDTRIGGER
BEFORE INSERT 
ON RTR_DT8N.CONVERSATIONS
REFERENCING NEW AS NEW
FOR EACH ROW 
DECLARE 
N_COUNT INTEGER; 
...
CREATE OR REPLACE VIEW RTR_DT8N.VW_TCIDTICKETS AS 
  SELECT DISTINCT LocalTCID, Bank1DealingCode FROM TICKETS ;
/


CREATE OR REPLACE VIEW RTR_DT8N.VW_POSSIBLEDUPLICATES  AS 
