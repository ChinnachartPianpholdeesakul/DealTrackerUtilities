...
:UPGRADE831
	...
	echo EXIT | SQLPLUS %conn% @"..\DT_Utilities_8.4.0\Setup\Oracle\Upgrade_Oracle_840.sql" >>%output%
	...
	echo EXIT | SQLPLUS %conn% @..\DT_Utilities_8.4.0\Setup\Oracle\AddVersion_Oracle_840.sql %majorRevision% %mediumRevision% %minorRevision% %releaseDate% %productName% >>%output%
	:: continue to next case

:UPGRADE840
	echo -- UPGRADE INSTALLATION FROM VERSION 8.4.0 -- >>%output%
	echo EXIT | SQLPLUS %conn% @"..\DT_Utilities_8.4.1\Setup\Oracle\Upgrade_Oracle_841.sql" >>%output%
	...
	set productName="'Deal Tracker Analyzer'"
	echo EXIT | SQLPLUS %conn% @..\DT_Utilities_8.4.1\Setup\Oracle\AddVersion_Oracle_841.sql %majorRevision% %mediumRevision% %minorRevision% %releaseDate% %productName% >>%output%
	:: continue to next case

:UPGRADE841
	echo -- UPGRADE INSTALLATION FROM VERSION 8.4.1 -- >>%output%
	echo EXIT | SQLPLUS %conn% @"..\DT_Utilities_8.5.0\Setup\Oracle\Upgrade_Oracle_850.sql" >>%output%
	...
	set productName="'Deal Tracker Analyzer'"
	echo EXIT | SQLPLUS %conn% @..\DT_Utilities_8.5.0\Setup\Oracle\AddVersion_Oracle_850.sql %majorRevision% %mediumRevision% %minorRevision% %releaseDate% %productName% >>%output%
	:: continue to next case
	
:UPGRADE850
	echo -- UPGRADE INSTALLATION FROM VERSION 8.5.0 -- >>%output%
	echo EXIT | SQLPLUS %conn% @"..\DT_Utilities_8.5.2\Setup\Oracle\Upgrade_Oracle_852.sql" >>%output%
	...
	set productName="'Deal Tracker Analyzer'"
	echo EXIT | SQLPLUS %conn% @..\DT_Utilities_8.5.2\Setup\Oracle\AddVersion_Oracle_852.sql %majorRevision% %mediumRevision% %minorRevision% %releaseDate% %productName% >>%output%
	:: continue to next case
	
:UPGRADE852
	echo -- UPGRADE INSTALLATION FROM VERSION 8.5.2 -- >>%output%
	echo EXIT | SQLPLUS %conn% @"..\DT_Utilities_8.5.3\Setup\Oracle\Upgrade_Oracle_853.sql" >>%output%
	...
	set productName="'Deal Tracker Analyzer'"
	echo EXIT | SQLPLUS %conn% @..\DT_Utilities_8.5.3\Setup\Oracle\AddVersion_Oracle_853.sql %majorRevision% %mediumRevision% %minorRevision% %releaseDate% %productName% >>%output%
	:: continue to next case
